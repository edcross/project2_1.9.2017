 ...
 * @author jcarlos2289
 */
/** Helper class for loading and saving data into txt files. */
public class FileMethods {
    
   /**
   * Save the content of a String in a TXT file in the pc.
   *
   * @param file Path to the file to read
   * @return List\<String\> object where every line in the file correspond to a object in the list
   * 
   */
   ...
   * Save the content of a String in a TXT file in the pc.
   *
   * @param cadTxt String to save in a Txt File
   * @param txtname Path and Name of the TXT file, w/o the extension of the file
   * @param append bool value to indicate if the File:txtname will be overwrited or the new text would be append to the existing one. 
   * 
   */
